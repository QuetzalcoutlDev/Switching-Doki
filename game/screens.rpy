...
style poemgame_text:
    ...
    hover_xoffset -3
    hover_outlines [(3, "#fff7ee", 0, 0), (2, "#ffeecc", 0, 0), (1, "#ffe4aa", 0, 0)]
...
style say_label:
    ...
    yalign 0.5
    outlines [(3, "#cc9b66", 0, 0), (1, "#cc9b66", 1, 1)]
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            textbutton _("Nuevo juego") action If(persistent.playername, true=Start(), false=Show(screen="name_input", message="Introduce tu nombre, por favor:", ok_action=Function(FinishEnterName)))
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("Vacio")):
        ...
        vbox:
            ...
            hbox:
                ...
                if renpy.variant("pc"):
                    ...
                    vbox:
                        ...
                        textbutton _("P.Completa") action Preference("display", "fullscreen")
                if config.developer:
                    vbox:
                        style_prefix "radio"
                ...
                vbox:
                    ...
                    textbutton _("Despues de elecciones") action Preference("after choices", "toggle")
                ...
                vbox:
                    ...
                    label _("Miscelaneas")
                    if main_menu:
                        textbutton _("Borrar todos los datos..."):
                            action Show(screen="confirm", message= _("Nota: Al eliminar todos los datos\n Perderás todo tu progreso realizado\n ¿Estás seguro de querer hacerlo?"), yes_action=Function(DeleteData), no_action=Hide(screen="confirm"))
                    textbutton _("Notificaciones"):
                        action Show(screen="notify_times", message=_("Ajusta el tiempo de duración de las notificaciones"), ok_action=Hide(screen="notify_times"))
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Tiempo de espera automatico")
...
screen notify(message, time_n=persistent.time_notify):
    ...
    timer time_n action Hide('notify')
